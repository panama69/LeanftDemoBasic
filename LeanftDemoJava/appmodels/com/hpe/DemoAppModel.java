...
@Generated(value = { "This class is automatically generated by the LeanFT Application Model code generator - version \"12.53\"" })
public class DemoAppModel extends AppModelBase {		private AdvantageShoppingPage AdvantageShoppingPage;
	
	public DemoAppModel(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("DemoAppModel");
	...
	private Password Password;
						public AdvantageShoppingPage(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
					...
					LoginBtn = new LoginBtn(this, applicationModel);
		UserName = new UserName(this, applicationModel);
		Password = new Password(this, applicationModel);
		...
		protected com.hp.lft.sdk.web.PageDescription createDescription() throws GeneralLeanFtException{
			...
			return description;
				...
				public LoginBtn LoginBtn() { return LoginBtn; }
		public UserName UserName() { return UserName; }
		public Password Password() { return Password; }
		
			public class LoginBtn extends ButtonNodeBase
	{

		
								public LoginBtn(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		...
		protected com.hp.lft.sdk.web.ButtonDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.ButtonDescription.Builder().buttonType("submit").tagName("BUTTON").name("LOGIN").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class UserName extends EditFieldNodeBase
	{

		
								public UserName(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("orderPaymenLogin_username");
		}
		...
		protected com.hp.lft.sdk.web.EditFieldDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.EditFieldDescription.Builder().type("text").tagName("INPUT").name("orderPaymenLogin_username").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class Password extends EditFieldNodeBase
	{

		
								public Password(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("orderPaymenLogin_password");
		}
		...
		protected com.hp.lft.sdk.web.EditFieldDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.web.EditFieldDescription description = null; 
			try{
				description = new com.hp.lft.sdk.web.EditFieldDescription.Builder().type("password").tagName("INPUT").name("orderPaymenLogin_password").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
